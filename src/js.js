...
const routePrices = {
  ochnauche: {
    horse: { price: '6000', duration: '5-6 часов', groupSize: 'до 6 человек' },
    foot: { price: '2000', duration: '7-8 часов', groupSize: 'до 10 человек' }
  },
  chasovny: {
    horse: { price: '2000', duration: '1-2 часа', groupSize: 'до 6 человек' },
    foot: { price: '1500', duration: '2-3 часа', groupSize: 'до 10 человек' }
  },
  bogatyrka: {
    horse: { price: '6000', duration: '5-6 часов', groupSize: 'до 6 человек' },
    foot: { price: '2000', duration: '7-8 часов', groupSize: 'до 10 человек' }
  ...
  klady: {
    horse: { price: '3000', duration: '2-3 часа', groupSize: 'до 6 человек' },
    foot: { price: '2000', duration: '3-4 часов', groupSize: 'до 10 человек' }
  },
  fars: {
    foot: { price: '2500', duration: '6-8 часов', groupSize: 'до 10 человек' }
  }
};
...
function setupPriceButtons() {
  ...
  if (horseOrderBtn) {
    horseOrderBtn.addEventListener('click', (e) => {
      ...
      alert('Выберите маршрут ниже и нажмите кнопку "Заказать"');
      togglePriceHighlight('horse');
    });
  }
